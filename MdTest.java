...
//  605 ___________________________________________________
	...
	public static void main(String[] args) {
		Scanner scan = new Scanner(System.in);//Input new method scan
//		int n = scan.nextInt();
//		
//		int arr1[] = new int[n];
//		int arr2[] = new int[n];
...
//		float height = scan.nextFloat();// only 1,75 format?????
...
//		}else System.out.println("NO");
	...
	static int answerN(String n1, String n2) {
